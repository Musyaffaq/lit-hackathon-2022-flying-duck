export const privacyLawData = [
  ...
  },
  {
    id: "28",
    code: "Is it an exception to access of personal data if:",
    question: "If the risk to the individual's privacy outweights the reason of access?",
    summary: "",
    category: "access",
  ...
  },
  {
    ...
    singapore: {
      country: "Singapore",
      info: "Yes",
      subInfo: "22.—(1)  An individual may request an organisation to correct an error or omission in the personal data about the individual that is in the possession or under the control of the organisation.",
    },
    malaysia: {
      country: "Malaysia",
      info: "Yes",
  ...
  },
  {
    id: "37",
    code: "Can correction request be rejected:",
    question: "If it is reasonable for them to do so?",
    summary: "",
    category: "correction",
